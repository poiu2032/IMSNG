...
def scamp(files) :
	...
	swarpcom = 'swarp -c astrom.swarp '+files+' -IMAGEOUT_NAME ah'+files+' -COPY_KEYWORDS OBJECT,DATE-OBS,EXPTIME,FILTER,RA,DEC,AIRMASS,OBSERVAT,JD,UTSTART,UTDATE' #-CENTER_TYPE MANUAL -CENTER 07:36:21.905,-69:32:01.26' # -IMAGE_SIZE 2400,1600
