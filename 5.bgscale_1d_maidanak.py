...
sys.path.append('/home/lim9/Desktop/IMSNG/9codes/5.apass_magConversion/')
import robust
import glob
...
for i in range(len(alllist)) :
	...
	for im in imlist : bgscale(im)
	os.chdir('../')	
os.system('ds9 */bgf*.fits &')
os.system('rm direc.list')
os.system('python /home/lim9/Desktop/IMSNG/9codes/automatic_1d_maidanak/6.imcopy_1d_maidanak_final.py')
