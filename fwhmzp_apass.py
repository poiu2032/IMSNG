...
os.system('gethead acf*.fits DATE-OBS FILTER EXP_TIME  > headinfo.txt')
os.system('ls acf*.fits > inim.list')
...
os.system('cp /home/sylee/Desktop/LOAO/Guideline_code/sex.config/phot.* .')
os.system('cp /home/sylee/Desktop/LOAO/Guideline_code/sex.config/default.conv .')
os.system('cp /home/sylee/Desktop/LOAO/Guideline_code/sex.config/default.nnw .')
g=open('fwhm.txt','w')
...
for i in range(len(inim)) :
	...
	matchcom="/home/sylee/starlink/star-2015B/starjava/bin/stilts tskymatch2 ifmt1=csv ifmt2=ascii in1="+refcat+" in2="+inimage[:-5]+".cat out="+inimage[:-5]+".merge.cat ra1=radeg dec1=decdeg ra2=col4 dec2=col5 error=1 join=1and2 ofmt=ascii omode=out"
	os.system(matchcom)	
