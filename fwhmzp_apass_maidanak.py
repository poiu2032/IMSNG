...
os.system('gethead acCalibrate*.fits DATE-OBS filter exptime  > headinfo.txt')
os.system('ls acCalibrate*.fits > inim.list')
...
for i in range(len(inim)) :
	...
	matchcom="stilts tskymatch2 ifmt1=csv ifmt2=ascii in1="+refcat+" in2="+inimage[:-5]+".cat out="+inimage[:-5]+".merge.cat ra1=radeg dec1=decdeg ra2=col4 dec2=col5 error=2 join=1and2 ofmt=ascii omode=out"
	os.system(matchcom)	
